...
| --- | --- | --- | --- |
| [C-0297](https://kubescape.io/docs/controls/c-0297/) | Agent Sandbox runtime isolation | kubescape-c-0297-agent-sandbox-runtime-isolation | agentRuntimeClassAllowList |
| [C-0298](https://kubescape.io/docs/controls/c-0298/) | Agent Sandbox service account token automount | kubescape-c-0298-agent-sandbox-token-automount | not configurable |
| [C-0299](https://kubescape.io/docs/controls/c-0299/) | Agent Sandbox container resource limits | kubescape-c-0299-agent-sandbox-container-limits | not configurable |
| [C-0300](https://kubescape.io/docs/controls/c-0300/) | Agent runtime image digest pinning | kubescape-c-0300-agent-sandbox-image-digests | not configurable |
| [C-0301](https://kubescape.io/docs/controls/c-0301/) | Agent runtime image registries | kubescape-c-0301-agent-sandbox-image-registries | imageRepositoryAllowList |
| [C-0302](https://kubescape.io/docs/controls/c-0302/) | Agent Sandbox managed network policy | kubescape-c-0302-agent-sandbox-managed-networking | not configurable |
...
| [C-0016](https://kubescape.io/docs/controls/c-0016/) | Allow privilege escalation | [kubescape-c-0016-allow-privilege-escalation](/docs/policies-based-on-kubescape-controls/kubescape-c-0016-deny-if-allow-privilege-escalation-not-set.md) | not configurable |
...
| [C-0200](https://kubescape.io/docs/controls/c-0200/) | Require drop all capabilities | [kubescape-c-0200-deny-added-capabilities](/docs/policies-based-on-kubescape-controls/kubescape-c-0200-deny-added-capabilities.md) | not configurable |
