...
You can apply policies to objects, for example, to apply control [C-0016](https://kubescape.io/docs/controls/c-0016/) (deny `allowPrivilegeEscalation` on containers) on workloads in the namespace with label `policy=enforced` just run this:
...
| [C-0013](https://kubescape.io/docs/controls/c-0013/) | Non-root containers | [kubescape-c-0013-deny-resources-with-capability-to-run-as-root](/docs/policies-based-on-kubescape-controls/kubescape-c-0013-deny-resources-with-capability-to-run-as-root.md) | not configurable | 
